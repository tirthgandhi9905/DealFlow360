    ...
    <div className="flex items-center justify-center min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="w-full max-w-md p-8 glass rounded-2xl animate-in fade-in zoom-in duration-500">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            type="submit" 
            className="w-full py-2.5 mt-2 rounded-lg bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/25 transition-all"
          >
            Sign In
          </button>
        </form>
        ...
        <div className="mt-6 space-y-3">
          <a href="/api/auth/google" className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg border border-border bg-white hover:bg-slate-50 text-sm font-medium transition-colors shadow-sm text-foreground">
